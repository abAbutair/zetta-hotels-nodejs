...
const api1 = function (res) {
    ...
    const paginationBtn = function (pages) {
        ...
        const prevBtn = `<li class="page-item"><button value="${state.page - 1}" class="btn btn--default pagination-btn">prev</button></li>`;
        paginationWrapper.insertAdjacentHTML('afterbegin', prevBtn);

        const nextBtn = `<li class="page-item"><button value="${state.page + 1}" class="btn btn--default pagination-btn">nxt</button></li>`;
